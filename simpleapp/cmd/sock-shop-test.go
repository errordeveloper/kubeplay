...
import (
	...
	simple "github.com/errordeveloper/kubeplay/simpleapp/api"
)

func main() {
	altPromPath := simple.AppComponentOpts{PrometheusPath: "/prometheus"}

	zipkinEnv := map[string]string{
		"ZIPKIN": "http://zipkin:9411/api/v1/spans",
	}

	mongo := simple.AppComponent{
		Image: "mongo",
		Port:  27017,
		Opts: simple.AppComponentOpts{
